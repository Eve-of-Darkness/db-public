...
CREATE TABLE `ItemUnique` (`Id_nb` VARCHAR(255) NOT NULL DEFAULT '' COLLATE NOCASE, 
...
`ItemUnique_ID` VARCHAR(255) DEFAULT NULL COLLATE NOCASE, 
PRIMARY KEY (`Id_nb`));
CREATE UNIQUE INDEX `U_ItemUnique_ItemUnique_ID` ON `ItemUnique` (`ItemUnique_ID`);
