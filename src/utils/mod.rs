...
pub fn download_database_from_github() -> Result<(),reqwest::Error> {
    ...
    eprintln!("Could not find asset {db_file_name} in https://api.github.com/repos/Eve-of-Darkness/db-public/releases");
    eprintln!("Abort execution");
    std::process::exit(2)
}
