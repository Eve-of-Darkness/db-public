...
INSERT INTO `ItemTemplate` (`Id_nb`,`Name`,`Level`,`Item_Type`,`Model`,`CanDropAsLoot`,`IsTradable`,`IsIndestructible`,`Object_Type`,`IsDropable`,`Quality`,`Weight`,`MaxCondition`,`MaxDurability`,`Condition`,`Durability`,`MaxCount`,`Description`,`Price`,`CanUseEvery`)
